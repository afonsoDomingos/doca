               ...
               >
                 <div style={{ padding: '1.25rem 0 0 0', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {[
                      ...
                      <div key={i} style={{ background: 'rgba(255,255,255,0.05)', borderRadius: '12px', border: selectedWpMsg === i ? '1px solid #FFCC00' : '1px solid transparent', overflow: 'hidden', transition: 'all 0.2s' }}>
                        <button
