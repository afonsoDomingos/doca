        ...
        <div style={{ marginBottom: '2rem', padding: '1.5rem', background: 'rgba(255,255,255,0.05)', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)' }}>
           ...
           <AnimatePresence>
             {showWpOptions && (
               ...
               >
                 <div style={{ padding: '1.25rem 0 0 0', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {[
                      { label: 'Aguardo Retorno', msg: 'Saudações! Acabei de fazer o pedido do meu orçamento no portal e aguardo pelo vosso retorno. Obrigado!' },
                      { label: 'Update de Obra', msg: 'Olá! Gostaria de receber uma atualização rápida sobre o estado atual do meu projeto.' }
                    ].map((whatsapp, i) => (
                      <a
                        key={i}
